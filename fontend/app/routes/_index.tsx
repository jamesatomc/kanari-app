...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-600 to-orange-800 dark:from-orange-900 dark:to-orange-950">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-16">
            <div className="md:w-1/2">
              <img
                ...
                className="rounded-lg shadow-2xl transform transition duration-500 hover:scale-105 ring-2 ring-orange-500/20"
              />
            </div>
  
            <div className="md:w-1/2 text-center md:text-left">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-white">
                Mint Your <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Exclusive</span> NFT
              </h1>
